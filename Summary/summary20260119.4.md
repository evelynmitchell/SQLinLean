...
2. The Spider corpus is valuable for identifying real-world parser gaps
3. Double-quoted strings and subqueries account for most parsing failures in real SQL
4. Non-standard multi-JOIN syntax (multiple JOINs before ON clause) exists in benchmarks
